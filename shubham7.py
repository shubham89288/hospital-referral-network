...
if st.session_state.edges
    ...
    st.write(fTop Doctor (Degree Centrality) {top_degree})
    st.write(fTop Doctor (Betweenness Centrality) {top_between})
    st.write(fTop Doctor (Closeness Centrality) {top_close})
